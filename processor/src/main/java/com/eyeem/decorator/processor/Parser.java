...
public class Parser {
   ...
   HashMap<String, DecoratedClassDefinition> map = new HashMap<>();
   Log log;

   Set<? extends TypeElement> annotations;
   RoundEnvironment roundEnv;

   /* package */ Parser(Log log, Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
      this.log = log;
   ...
   private void parse() {
      ...
      for (TypeElement annotation : annotations) {
         ...
         for (Element element : roundEnv.getElementsAnnotatedWith(annotation)) {
            ...
            TypeElement typeElement = Utils.getClass(element);
   ...
   public Collection<DecoratedClassDefinition> definitions() {
      return map.values();
   }
}
