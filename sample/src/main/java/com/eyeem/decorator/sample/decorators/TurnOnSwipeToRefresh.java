 ...
 */
public class TurnOnSwipeToRefresh extends Deco implements View.OnClickListener {
   ...
   public void setupRecyclerView(RecyclerView recyclerView, WrapAdapter wrapAdapter, RecyclerView.Adapter adapter) {
      ...
      v.setText("Click to enable Swipe To Refresh");
   ...
   @Override public void onClick(View v) {
      IntentUtil.startActivity(getDecorated(), getDecorators().buildUpon()
            .removeDecorator(TurnOnSwipeToRefresh.class)
            .addDecorator(TurnOnCoordinatorLayout.class)
            .addDecorator(SwipeToRefreshDecorator.class)
      );
   }
}
